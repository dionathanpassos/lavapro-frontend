      ...
      >
        <header className="mb-6">
          ...
          <span className="text-muted-foreground text-sm">
            {editing
              ? "Gerencie os dados e acessos deste usuário."
            ...
            <div className="flex flex-col gap-6">
              <div className="pt-4 flex flex-col gap-4">
                <span className="text-sm font-medium text-muted-foreground">
                  {editing ? "Alterar senha do usuário" : "Definir senha inicial"}
                </span>
                ...
                <Input
                  ...
                  type={"password"}
                  value={form.password || ""}
                  placeholder={editing ? "Digite a nova senha se desejar alterar" : "Senha de acesso"}
                  onChange={onChange}
