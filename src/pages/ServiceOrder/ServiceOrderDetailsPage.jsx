...
import { deliverServiceOrder, finishtServiceOrder, getServiceOrderById, startServiceOrder } from "../../services/serviceOrderService";
...
export default function ServiceOrderDetailsPage({
  ...
  const loadServiceOrder = useCallback(async () => {
    try {
      ...
      console.error("Erro ao carregar os dados da OS", error);
    } finally {
      setLoading(false);
    }
  }, [id]);
  ...
  return (
    <>
      <div className="min-h-screen bg-slate-50 text-foreground z-100">
            ...
            <div className="grid grid-cols-1 gap-4 xl:grid-cols-[minmax(0,1fr)_330px]">
              ...
              <div className="space-y-4">
                ...
                <StatusTimeline
                  ...
                  onChangeStaus={() => setModalConfirm(true)}
                />
              </div>
              { modalConfirm && (
                <ModalChangeStatus
      ...
      {isOpenPayment && (
        <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-sm flex items-center justify-center z-150 p-4 transition-all">
          {/* Container Principal do Modal baseado no Design */}
          <div className="bg-white rounded-2xl w-160 p-6 shadow-2xl border border-gray-100 flex flex-col max-h-[95vh] overflow-y-auto font-sans">
            ...
            <form onSubmit={handleSubmitPayment} className="space-y-5 flex-1">
              {/* Grid de Conteúdo Central Duplo */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                ...
                <div className="space-y-4 p-2">
                  ...
                  {/* Informações Extras de Pagamento */}
                ...
                {/* Coluna Direita: Métodos Selecionáveis (Layout Rádio com Borda) */}
                <div className="space-y-4 p-2">
                  <h3 className="text-sm font-bold text-gray-900 m-0 tracking-wide mb-4">
                    Forma de pagamento *
                  </h3>
